...
function creation_cpt_recette() {
	...
	$labels = array(
		...
		'new_item'              => __( 'Nouvelles recettes', 'text_domain' ),
...
add_action( 'init', 'creation_cpt_recette', 0 );

//CPT CHEFS
// Register Custom Post Type
// Register Custom Post Type
function creation_cpt_chef() {
	...
	$labels = array(
		...
		'all_items'             => __( 'All Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
		'add_new'               => __( 'Ajouter un Chef', 'text_domain' ),
		'new_item'              => __( 'Nouveaux Chef', 'text_domain' ),
		'edit_item'             => __( 'Éditer une fiche chef', 'text_domain' ),
		'update_item'           => __( 'Mettre à jour une fiche chef', 'text_domain' ),
		'view_item'             => __( 'View Item', 'text_domain' ),
		'view_items'            => __( 'View Items', 'text_domain' ),
		'search_items'          => __( 'Search Item', 'text_domain' ),
		'not_found'             => __( 'Not found', 'text_domain' ),
